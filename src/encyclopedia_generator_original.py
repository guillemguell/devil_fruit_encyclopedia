...
csv_path = Path("C:/Users/usuari/source/repos/one_piece_database/data/raw/devil_fruits_raw.csv")
out_html = Path("C:/Users/usuari/source/repos/one_piece_database/src/devil_fruit_encyclopedia/devil_fruit_encyclopedia.html")
img_base = Path("C:/Users/usuari/source/repos/one_piece_database/data/raw/devil_fruits_imgs/")
mp3_path = Path("C:/Users/usuari/source/repos/one_piece_database/src/devil_fruit_encyclopedia/turn_a_page.mp3")
...
if not csv_path.exists():
    ...
    with csv_path.open(newline='', encoding='utf-8') as f:
        ...
        for row in reader:
            ...
            if name and parse_bool(is_canon_field):
                entries.append({
                    "name": name,
                    "type": typ,
                    "abilities": abilities
    ...
    if not img_file.exists():
        ...
        for alt in [alt_png, alt_jpg, alt_jpeg]:
            if alt.exists():
                ...
                break
    if img_file.exists():
        entry["image"] = f"file:///{img_file.as_posix()}"
    else:
        entry["image"] = None
...
<html lang="en">
  <head>
    ...
    <audio id="pageFlipSound" preload="auto">
      <source src="<<FLIP_PAGE_MP3>>" type="audio/mpeg">
    </audio>
...
final_html = html_template.replace("<<IMG_BASE>>", img_base.as_uri()).replace("<<ENTRIES>>", entries_json).replace("<<FLIP_PAGE_MP3>>",mp3_path.as_uri())

out_html.write_text(final_html, encoding="utf-8")
print(f"Wrote HTML to {out_html.resolve()} (entries: {len(entries)})")
